...
class Test_channels():
    ...
    def test_personalInfoDeclartionasY(self, poco, reloadRoute):
        ...
        with allure.step("勾选本人同意艾德证券如上述情况使用本人的个人资料"):
            channel.click_personalInfoDeclartionLangsasImgview()
...
if __name__ == "__main__":
    pytest.main(["-s", "test_10_channels.py::Test_channels::test_personalInfoDeclartionasY", '--alluredir', '../report/xml_{time}'.format(time=datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S'))])
